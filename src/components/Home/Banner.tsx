...
export default function KanturuAwakens() {
  return (
    <div className="scrub relative flex h-[303px] flex-col items-start justify-between overflow-hidden bg-[url('/home/banner.webp')] bg-cover bg-[position:center_right] p-8">
